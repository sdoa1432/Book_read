...
public class PageModeDialog extends Dialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        selectPageMode(spfControl.getPageMode());
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.tv_simulation:
                selectPageMode(DataConstants.PAGE_MODE_SIMULATION);
                setPageMode(DataConstants.PAGE_MODE_SIMULATION);
                break;
            case R.id.tv_cover:
                selectPageMode(DataConstants.PAGE_MODE_COVER);
                setPageMode(DataConstants.PAGE_MODE_COVER);
                break;
            case R.id.tv_slide:
                selectPageMode(DataConstants.PAGE_MODE_SLIDE);
                setPageMode(DataConstants.PAGE_MODE_SLIDE);
                break;
            case R.id.tv_none:
                selectPageMode(DataConstants.PAGE_MODE_NONE);
                setPageMode(DataConstants.PAGE_MODE_NONE);
                break;
        }
    }
    ...
    public void setPageMode(int pageMode) {
        spfControl.setPageMode(pageMode);
    ...
    private void selectPageMode(int pageMode) {
        if (pageMode == DataConstants.PAGE_MODE_SIMULATION) {
        ...
        } else if (pageMode == DataConstants.PAGE_MODE_COVER) {
            setTextViewSelect(tv_simulation, false);
            setTextViewSelect(tv_cover, true);
            setTextViewSelect(tv_slide, false);
            setTextViewSelect(tv_none, false);
        } else if (pageMode == DataConstants.PAGE_MODE_SLIDE) {
            setTextViewSelect(tv_simulation, false);
            setTextViewSelect(tv_cover, false);
            setTextViewSelect(tv_slide, true);
            setTextViewSelect(tv_none, false);
        } else if (pageMode == DataConstants.PAGE_MODE_NONE) {
            setTextViewSelect(tv_simulation, false);
            setTextViewSelect(tv_cover, false);
            setTextViewSelect(tv_slide, false);
